...
<div class="row"> <!-- start 2nd row  -->
	...
	<div class="controls">
		<input type="text" name="subsubcategory_id" class="form-control" required="">
...
<div class="row"> <!-- start 4th row  -->
	<div class="col-md-4">
		...
		<div class="form-group">
			...
			<div class="controls">
	 <input type="text" name="product_color_en" class="form-control" value="red,Black,None" data-role="tagsinput" >
...
<hr>
						  <div class="row">
							...
							<div class="col-md-3 offset-md-3"><input type="submit" class="btn btn-rounded btn-primary mb-5" value="Add Product"></div>
						  </div>
